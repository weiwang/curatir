...
artist_names = json.load(open("../../app/static/artist_101_names.json"))
...
def rec(num):
    ...
    print "Artists similar to " + artist_names[num]
    pp.pprint([x[0] for x in sorted_sims][1:6])
...
for num in range(0, 101):
    ...
    dist_mat[artist_names[num]] = (sorted_sims[1:])
